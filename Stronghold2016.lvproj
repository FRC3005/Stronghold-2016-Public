...
<Project Type="Project" LVVersion="15008000">
	<Property Name="CCSymbols" Type="Str">ActiveBot,Competition;HAS_VISION,False;</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Auton" Type="Folder">
			<Item Name="SubVI" Type="Folder">
				<Item Name="Auton System Monitor.vi" Type="VI" URL="../Autonomous/SubVI/Auton System Monitor.vi"/>
				<Item Name="Drive Distance to Turn Angle.vi" Type="VI" URL="../SubVI/Drive Distance to Turn Angle.vi"/>
				<Item Name="Drive Forward to Position.vi" Type="VI" URL="../Autonomous/SubVI/Drive Forward to Position.vi"/>
				<Item Name="Follow 1D Motion Profile for Turning.vi" Type="VI" URL="../Autonomous/SubVI/Follow 1D Motion Profile for Turning.vi"/>
				<Item Name="Follow 1D Motion Profile.vi" Type="VI" URL="../Autonomous/SubVI/Follow 1D Motion Profile.vi"/>
				<Item Name="Generate 1D Motion Profile Method 2.vi" Type="VI" URL="../Autonomous/SubVI/Generate 1D Motion Profile Method 2.vi"/>
				<Item Name="Turn Angle to Drive Distance.vi" Type="VI" URL="../SubVI/Turn Angle to Drive Distance.vi"/>
			</Item>
			<Item Name="Typedef" Type="Folder">
				<Item Name="Auton System Monitor.ctl" Type="VI" URL="../Autonomous/SubVI/Auton System Monitor.ctl"/>
				<Item Name="AutonRefType.ctl" Type="VI" URL="../Autonomous/Typedef/AutonRefType.ctl"/>
				<Item Name="Defences.ctl" Type="VI" URL="../Autonomous/Typedef/Defences.ctl"/>
				<Item Name="MainStates.ctl" Type="VI" URL="../Autonomous/Typedef/MainStates.ctl"/>
				<Item Name="Motion Profile.ctl" Type="VI" URL="../Autonomous/Typedef/Motion Profile.ctl"/>
			</Item>
		</Item>
		<Item Name="IntakeController" Type="Folder">
			<Item Name="Commands" Type="Folder">
				<Item Name="Arm Transfer F to R.vi" Type="VI" URL="../SubVI/CompoundActions/Arm Transfer F to R.vi"/>
				<Item Name="Arm Transfer F to R_new.vi" Type="VI" URL="../SubVI/CompoundActions/Arm Transfer F to R_new.vi"/>
				<Item Name="Arm Transfer R to F.vi" Type="VI" URL="../SubVI/CompoundActions/Arm Transfer R to F.vi"/>
				<Item Name="Arm Transfer R to F_new.vi" Type="VI" URL="../SubVI/CompoundActions/Arm Transfer R to F_new.vi"/>
				<Item Name="Auto Shoot Front.vi" Type="VI" URL="../SubVI/CompoundActions/Auto Shoot Front.vi"/>
				<Item Name="AutoIntakeFront.vi" Type="VI" URL="../SubVI/CompoundActions/AutoIntakeFront.vi"/>
				<Item Name="AutoIntakeFront_new.vi" Type="VI" URL="../SubVI/CompoundActions/AutoIntakeFront_new.vi"/>
				<Item Name="AutoIntakeRear.vi" Type="VI" URL="../SubVI/CompoundActions/AutoIntakeRear.vi"/>
				<Item Name="AutoShootRear.vi" Type="VI" URL="../SubVI/CompoundActions/AutoShootRear.vi"/>
				<Item Name="Command VI.vit" Type="VI" URL="../SubVI/CompoundActions/Command VI.vit"/>
				<Item Name="Set Arm.vi" Type="VI" URL="../SubVI/CompoundActions/Set Arm.vi"/>
				<Item Name="Set Roller.vi" Type="VI" URL="../SubVI/CompoundActions/Set Roller.vi"/>
				<Item Name="Turtle Rollers Off.vi" Type="VI" URL="../SubVI/CompoundActions/Turtle Rollers Off.vi"/>
				<Item Name="Turtle Rollers Off Rear.vi" Type="VI" URL="../SubVI/CompoundActions/Turtle Rollers Off Rear.vi"/>
			</Item>
			<Item Name="Typedef" Type="Folder">
				<Item Name="Command List.ctl" Type="VI" URL="../IntakeController/Typedef/Command List.ctl"/>
				<Item Name="Front Arm List.ctl" Type="VI" URL="../IntakeController/Typedef/Front Arm List.ctl"/>
				<Item Name="IntakeControllerActions.ctl" Type="VI" URL="../Typedef/IntakeControllerActions.ctl"/>
				<Item Name="IntakeControllerMsg.ctl" Type="VI" URL="../Typedef/IntakeControllerMsg.ctl"/>
				<Item Name="Rear Arm List.ctl" Type="VI" URL="../IntakeController/Typedef/Rear Arm List.ctl"/>
			</Item>
			<Item Name="GetIntakeQueue.vi" Type="VI" URL="../IntakeController/SubVI/GetIntakeQueue.vi"/>
			<Item Name="Parse Cmds.vi" Type="VI" URL="../SubVI/CompoundActions/Parse Cmds.vi"/>
		</Item>
		<Item Name="Resource" Type="Folder">
			<Item Name="CameraAttr.csv" Type="Document" URL="../CameraAttr.csv"/>
		</Item>
		<Item Name="RollerController" Type="Folder">
			<Item Name="IntakeCmd.ctl" Type="VI" URL="../RollerController/IntakeCmd.ctl"/>
		</Item>
		<Item Name="SubVI" Type="Folder">
			<Item Name="Vision" Type="Folder">
				<Item Name="Image Size to Width DBL.vi" Type="VI" URL="../SubVI/Vision/Image Size to Width DBL.vi"/>
				<Item Name="Moment Score.vi" Type="VI" URL="../SubVI/Vision/Moment Score.vi"/>
				<Item Name="Normalize Coordinates.vi" Type="VI" URL="../SubVI/Vision/Normalize Coordinates.vi"/>
				<Item Name="Normalized Range Compare 2016.vi" Type="VI" URL="../SubVI/Vision/Normalized Range Compare 2016.vi"/>
				<Item Name="Sorted Particle Report 2016.vi" Type="VI" URL="../SubVI/Vision/Sorted Particle Report 2016.vi"/>
				<Item Name="Angles to Targets.vi" Type="VI" URL="../SubVI/Vision/Angles to Targets.vi"/>
				<Item Name="Area Scoring.vi" Type="VI" URL="../SubVI/Vision/Area Scoring.vi"/>
				<Item Name="Aspect Ratio Score 2016.vi" Type="VI" URL="../SubVI/Vision/Aspect Ratio Score 2016.vi"/>
				<Item Name="Calculate Particle Scores.vi" Type="VI" URL="../SubVI/Vision/Calculate Particle Scores.vi"/>
				<Item Name="Compute DistanceToTarget2.vi" Type="VI" URL="../SubVI/Vision/Compute DistanceToTarget2.vi"/>
				<Item Name="Label Targets2.vi" Type="VI" URL="../SubVI/Vision/Label Targets2.vi"/>
			</Item>
			<Item Name="Peak Detect.vi" Type="VI" URL="../SubVI/Peak Detect.vi"/>
			<Item Name="Set Shifter.vi" Type="VI" URL="../SubVI/Set Shifter.vi"/>
			<Item Name="WPILib Camera Set Attributes From File.vi" Type="VI" URL="../SubVI/WPILib Camera Set Attributes From File.vi"/>
			<Item Name="XBox Axis.ctl" Type="VI" URL="../Typedef/XBox Axis.ctl"/>
			<Item Name="XBox Buttons.ctl" Type="VI" URL="../Typedef/XBox Buttons.ctl"/>
			<Item Name="XBox POV.ctl" Type="VI" URL="../Typedef/XBox POV.ctl"/>
			<Item Name="ChangeDriveTrainDeadband.vi" Type="VI" URL="../SubVI/ChangeDriveTrainDeadband.vi"/>
		</Item>
		...
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Teleop_Alternate.vi" Type="VI" URL="../Teleop_Alternate.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../Test.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
		</Item>
		<Item Name="ArmController.lvlib" Type="Library" URL="../ArmController/ArmController.lvlib"/>
		<Item Name="navX Library v2.lvlib" Type="Library" URL="../NavX/navX Library v2.lvlib"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Destination[2].destName" Type="Str">User Data</Property>
				<Property Name="Destination[2].path" Type="Path">/home/lvuser</Property>
				<Property Name="Destination[2].path.type" Type="Str">&lt;none&gt;</Property>
				<Property Name="DestinationCount" Type="Int">3</Property>
				<Property Name="Source[0].itemID" Type="Str">{BB01320B-0DC0-48E3-A61D-1DC98E5FA3D1}</Property>
